layui.define(['jquery','D','mm'], function (exports) {
	var index={
		...
		items:[
			{img:'https://7up.pics/images/2023/11/24/sy_img1.jpeg',title:'大型网站技术架构：摘要与读书笔记',type:'架构文章',isNew:1,url:'#',
			text:`花了几个晚上看完了《大型网站技术架构》这本书，个人感觉这本书的广度还行，
				...
				text:`花了几个晚上看完了《大型网站技术架构》这本书，个人感觉这本书的广度还行，
									深度还有些欠缺（毕竟只有200页左右）。但是作为一个缺乏大型网站技术的IT民工，看完一遍还是很有收获的，
									至少对一个网站的技术演进、需要解决的问题有了一个全面的认识。文中也有一些作者个人的心得、感悟、总结，我觉得还是很中肯的。`},
			{img:'https://7up.pics/images/2023/11/24/sy_img1.jpeg',title:'大型网站技术架构：摘要与读书笔记',type:'架构文章',isNew:0,url:'#',
			text:`花了几个晚上看完了《大型网站技术架构》这本书，个人感觉这本书的广度还行，
								深度还有些欠缺（毕竟只有200页左右）。但是作为一个缺乏大型网站技术的IT民工，看完一遍还是很有收获的，
								至少对一个网站的技术演进、需要解决的问题有了一个全面的认识。文中也有一些作者个人的心得、感悟、总结，我觉得还是很中肯的。`},
			{img:'https://7up.pics/images/2023/11/24/sy_img1.jpeg',title:'大型网站技术架构：摘要与读书笔记',type:'架构文章',isNew:0,url:'#',
